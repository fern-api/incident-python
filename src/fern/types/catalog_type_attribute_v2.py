...
class CatalogTypeAttributeV2(UniversalBaseModel):
    ...
    mode: CatalogTypeAttributeV2Mode = pydantic.Field()
    """
    ...
    path: typing.Optional[typing.List[CatalogTypeAttributePathItemV2]] = pydantic.Field(default=None)
    """
