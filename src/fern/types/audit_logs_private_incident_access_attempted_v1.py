...
from .audit_log_private_incident_access_attempted_metadata_v2 import AuditLogPrivateIncidentAccessAttemptedMetadataV2
from .audit_log_target_v2 import AuditLogTargetV2


class AuditLogsPrivateIncidentAccessAttemptedV1(UniversalBaseModel):
