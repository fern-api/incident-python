...
class EscalationPathNodeV2(UniversalBaseModel):
    ...
    if_else: typing.Optional["EscalationPathNodeIfElseV2"] = None
    ...
    type: EscalationPathNodeV2Type = pydantic.Field()
    """
...
update_forward_refs(EscalationPathNodeV2, EscalationPathNodeIfElseV2=EscalationPathNodeIfElseV2)
