...
A full reference for this library is available [here](https://github.com/fern-api/incident-python/blob/HEAD/./reference.md).
...
response = client.custom_field_options_v1.with_raw_response.create(...)
...
```python
client.custom_field_options_v1.create(..., request_options={
    "max_retries": 1
})
```
